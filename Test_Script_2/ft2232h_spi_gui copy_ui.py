...
################################################################################
## Form generated from reading UI file 'ft2232h_spi_gui copy.ui'
##
...
class Ui_SPI_Master_GUI(object):
    ...
    def retranslateUi(self, SPI_Master_GUI):
        ...
        self.freq_edit.setText(QCoreApplication.translate("SPI_Master_GUI", u"1000000", None))
        ...
        self.data_edit.setText(QCoreApplication.translate("SPI_Master_GUI", u"12345678", None))
