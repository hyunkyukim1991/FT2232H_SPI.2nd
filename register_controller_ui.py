...
class Ui_RegisterTreeViewer(object):
    def setupUi(self, RegisterTreeViewer):
        ...
        self.control_widget.setMinimumSize(QSize(500, 0))
        ...
        self.single_register_group = QGroupBox(self.control_widget)
        self.single_register_group.setObjectName(u"single_register_group")
        self.single_register_group.setMaximumSize(QSize(16777215, 80))
        self.single_register_layout = QHBoxLayout(self.single_register_group)
        self.single_register_layout.setObjectName(u"single_register_layout")
        self.addr_label = QLabel(self.single_register_group)
        self.addr_label.setObjectName(u"addr_label")

        self.single_register_layout.addWidget(self.addr_label)

        self.addr_edit = QLineEdit(self.single_register_group)
        self.addr_edit.setObjectName(u"addr_edit")
        self.addr_edit.setMaximumSize(QSize(80, 16777215))

        self.single_register_layout.addWidget(self.addr_edit)

        self.data_label = QLabel(self.single_register_group)
        self.data_label.setObjectName(u"data_label")

        self.single_register_layout.addWidget(self.data_label)

        self.data_edit = QLineEdit(self.single_register_group)
        self.data_edit.setObjectName(u"data_edit")
        self.data_edit.setMaximumSize(QSize(120, 16777215))

        self.single_register_layout.addWidget(self.data_edit)

        self.single_write_btn = QPushButton(self.single_register_group)
        self.single_write_btn.setObjectName(u"single_write_btn")
        self.single_write_btn.setEnabled(False)

        self.single_register_layout.addWidget(self.single_write_btn)

        self.single_read_btn = QPushButton(self.single_register_group)
        self.single_read_btn.setObjectName(u"single_read_btn")
        self.single_read_btn.setEnabled(False)

        self.single_register_layout.addWidget(self.single_read_btn)

        self.single_register_spacer = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.single_register_layout.addItem(self.single_register_spacer)


        self.control_layout.addWidget(self.single_register_group)
...
#endif // QT_CONFIG(tooltip)
        self.single_register_group.setTitle(QCoreApplication.translate("RegisterTreeViewer", u"Single Register Control", None))
        self.addr_label.setText(QCoreApplication.translate("RegisterTreeViewer", u"Address (0x):", None))
        self.addr_edit.setText(QCoreApplication.translate("RegisterTreeViewer", u"00", None))
#if QT_CONFIG(tooltip)
        self.addr_edit.setToolTip(QCoreApplication.translate("RegisterTreeViewer", u"Register address in hexadecimal (without 0x prefix)", None))
#endif // QT_CONFIG(tooltip)
        self.data_label.setText(QCoreApplication.translate("RegisterTreeViewer", u"Data (0x):", None))
        self.data_edit.setText(QCoreApplication.translate("RegisterTreeViewer", u"00000000", None))
#if QT_CONFIG(tooltip)
        self.data_edit.setToolTip(QCoreApplication.translate("RegisterTreeViewer", u"Data value in hexadecimal (without 0x prefix)", None))
#endif // QT_CONFIG(tooltip)
        self.single_write_btn.setText(QCoreApplication.translate("RegisterTreeViewer", u"Single Write", None))
        self.single_write_btn.setStyleSheet(QCoreApplication.translate("RegisterTreeViewer", u"background-color: #E91E63; color: white; font-weight: bold;", None))
#if QT_CONFIG(tooltip)
        self.single_write_btn.setToolTip(QCoreApplication.translate("RegisterTreeViewer", u"Write data to specified address", None))
#endif // QT_CONFIG(tooltip)
        self.single_read_btn.setText(QCoreApplication.translate("RegisterTreeViewer", u"Single Read", None))
        self.single_read_btn.setStyleSheet(QCoreApplication.translate("RegisterTreeViewer", u"background-color: #00BCD4; color: white; font-weight: bold;", None))
#if QT_CONFIG(tooltip)
        self.single_read_btn.setToolTip(QCoreApplication.translate("RegisterTreeViewer", u"Read data from specified address", None))
#endif // QT_CONFIG(tooltip)
